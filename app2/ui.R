...
bnorm <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T,
      box(plotOutput("dnorm1"), solidHeader = TRUE,height = 400),
      ...
      box(plotOutput("dnorm2"), solidHeader = TRUE)
  )
)
...
bbin <- fluidRow(
  ...
  box(title = "Représentation graphique",width = 12,status = "info",solidHeader = T,
      ...
      box(plotOutput("dbinom3"),solidHeader = TRUE),
      box(title="Contrôle :",solidHeader = TRUE,
          sliderInput(inputId = "ech2", label = "Taille de l'échantillon",min = 2, max = 10000, value = 1000),
...
bexp <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T,
      box(plotOutput("dexp1"),solidHeader = TRUE,height = 400),
      box(title="Contrôle :",solidHeader = TRUE,height = 400,
      ...
      box(plotOutput("dexp2"),solidHeader = TRUE)
  )
)
...
bpoiss <- fluidRow(
  ...
  box(title = "Représentation graphique",width = 12,status = "info",solidHeader = T,
      ...
      box(plotOutput("dpois2"),solidHeader = TRUE, height = 400),
      box(plotOutput("dpois3"),solidHeader = TRUE,height = 400),
      box(title="Contrôle :",solidHeader = TRUE,
          sliderInput(inputId = "ech4", label = "Taille de l'échantillon",min = 2, max = 10000, value = 1000),
...
bunifc <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T, 
      box(plotOutput("dunif1"),solidHeader = TRUE, height = 400),
      box(title="Contrôle :",solidHeader = TRUE, height = 400,
      ...
      box(plotOutput("dunif2"),solidHeader = TRUE)
  )
)
...
bgamma <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T,
      box(plotOutput("dgamma1"),solidHeader = TRUE, height = 400),
      box(title="Contrôle :",solidHeader = TRUE, height = 400,
          sliderInput(inputId = "ech6", label = "Taille de l'échantillon",min = 2, max = 10000, value = 1000),
          sliderInput(inputId = "bins4",
                      label = "Nombre de classes",
                      min=1, max = 50,value = 30),
          sliderInput(inputId = "p",label = "Valeur de \\(p\\)", min = 0.01, max = 15, value =1.5,step = 0.02),
          sliderInput(inputId = "teta",label = "Valeur de \\(\\theta\\)", min = 0.01, max = 15, value = 1.5,step = 0.02)
      ),
      box(plotOutput("dgamma2"),solidHeader = TRUE)
  )
)
...
bkhid <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T,
      box(plotOutput("dchisq1"),solidHeader = TRUE, height = 400),
      box(title="Contrôle :",solidHeader = TRUE, height = 400,
      ...
      box(plotOutput("dchisq2"),solidHeader = TRUE)
  )
)
...
bstudent <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T,
      box(plotOutput("dt1"),solidHeader = TRUE, height = 400),
      box(title="Contrôle :",solidHeader = TRUE, height = 400,
      ...
      box(plotOutput("dt2"),solidHeader = TRUE)
  )
)
...
bfisher <- fluidRow(
  ...
  box(title = "Représentation graphique de la densité",width = 12,status = "info",solidHeader = T,
      box(plotOutput("df1"),solidHeader = TRUE, height = 400),
      box(title="Contrôle :",solidHeader = TRUE, height = 400,
      ...
      box(plotOutput("df2"),solidHeader = TRUE)
  )
)
