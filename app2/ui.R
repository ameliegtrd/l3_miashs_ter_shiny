...
ui <- dashboardPage(skin = "red",
                    ...
                    dashboardSidebar( 
                        sidebarMenu(
                            ...
                            menuItem("Loi Normale", tabName = "lnorm", icon = icon("arrow-right") # icon th sinon
                                     ),
                            menuItem("Loi Binomiale", tabName = "lbin", icon = icon("arrow-right")
                                     ),
                            menuItem("Loi Exponentielle", tabName = "lexp", icon = icon("arrow-right")
                                     ),
                            menuItem("Loi de Poisson", tabName = "lpoiss", icon = icon("arrow-right")
                                     ),
                            ...
                            menuItem("Application TCL", icon = icon("file-code"),href="https://ter-shiny-miashs.shinyapps.io/app1/"
                                     )
                        )
                    ),
                    # contenu de la page
                    dashboardBody(withMathJax(), includeCSS("www/style1.css"),
                                  tabItems(
                                      ...
                                      tabItem(tabName = "lnorm",bnorm
                                              ),
                                      # page de la loi binomiale
                                      tabItem(tabName = "lbin",bbin
                                              ),
                                      # page de la loi exponentielle
                                      tabItem(tabName = "lexp",bexp
                                              ),
                                      # page de la loi de poisson
                                      tabItem(tabName = "lpoiss",bpoiss
                                              ),
                                      # page de la loi uniforme continue
                                      tabItem(tabName = "lunifc",bunifc
                                              ),
                                      # page de la loi gamma
                                      tabItem(tabName = "lgamma",bgamma
                                              ), 
                                      # page de la loi du khi deux
                                      tabItem(tabName = "lkhid",bkhid
                                              ),
                                      # page de la loi de student
                                      tabItem(tabName = "lstudent",bstudent
                                              ),
                                      # page de la loi de fisher
                                      tabItem(tabName = "lfisher",bfisher
                                              ),
                                      # page sources
